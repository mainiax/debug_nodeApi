...
exports.getTour = catchAsync(async (req, res, next) => {
  ...
  res
    ...
    .set(
      ...
      //"default-src 'self' https://*.mapbox.com; connect-src 'self' ws://localhost:56875/; base-uri 'self'; block-all-mixed-content; font-src 'self' https: data:; frame-ancestors 'self'; img-src 'self' data:; object-src 'none'; script-src https://cdnjs.cloudflare.com https://api.mapbox.com 'self' blob: ; script-src-attr 'none'; style-src 'self' https: 'unsafe-inline'; upgrade-insecure-requests;"
    )
